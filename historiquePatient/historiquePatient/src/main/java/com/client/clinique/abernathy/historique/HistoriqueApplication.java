...
//	@Override
	public void run(String... args) throws Exception {
		Historique historique = new Historique(1, "Poids");
		Historique historique2 = new Historique(1, "fatigue. Tests de laboratoire indiquant une microalbumine élevée");
		Historique historique3 = new Historique(1,
				" Fumeur. Tests de laboratoire indiquant que les anticorps sont élevés");
		Historique historique4 = new Historique(2,
				"stress " + "Il se plaint également que son audition est anormal dernièrement");
